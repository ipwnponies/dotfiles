...
- If it is ambiguous whether input is a commit message or intent/context, use the `question` tool to ask the user if the input was meant to be the commit message.
