...
-- Abbreviations:
vim.keymap.set("ia", "todo:", "TODO(TICKET):")
vim.keymap.set("ca", "w!!", "w !sudo tee >/dev/null %") -- Command-line: allows saving file with sudo using 'w!!'
...
vim.opt.colorcolumn = "+1" -- Highlight column past textwidth as a boundary
